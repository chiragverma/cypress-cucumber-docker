class homePage {
    ...
    static searchHotel(place, checkin, checkout) {
      cy.get(homeSelector.place).clear().type(place);
      cy.get(homeSelector.checkin).type(checkin);
      cy.get(homeSelector.checkout).type(checkout);
